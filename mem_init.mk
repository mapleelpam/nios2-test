...
# Memory: epcq_controller2_0
MEM_0 := epcq_controller2_0
$(MEM_0)_NAME := epcq_controller2_0
HEX_FILES += $(MEM_INIT_DIR)/$(MEM_0).hex
MEM_INIT_INSTALL_FILES += $(MEM_INIT_INSTALL_DIR)/$(MEM_0).hex
$(MEM_0)_START := 0x20000000
$(MEM_0)_END := 0x23ffffff
$(MEM_0)_SPAN := 0x04000000
$(MEM_0)_HIERARCHICAL_PATH := epcq_controller2_0
$(MEM_0)_WIDTH := 32
...
.PHONY: epcq_controller2_0
epcq_controller2_0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex

# Memory: mem_if_ddr3_emif_0
MEM_1 := mem_if_ddr3_emif_0
$(MEM_1)_NAME := mem_if_ddr3_emif_0
$(MEM_1)_MEM_INIT_FILE_PARAM_NAME := ABS_RAM_MEM_INIT_FILENAME
$(MEM_1)_START := 0x00000000
$(MEM_1)_END := 0x1fffffff
$(MEM_1)_SPAN := 0x20000000
$(MEM_1)_HIERARCHICAL_PATH := mem_if_ddr3_emif_0
$(MEM_1)_WIDTH := 64
$(MEM_1)_HEX_DATA_WIDTH := 64
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0


# Memory: onchip_memory2_0
MEM_2 := nios_onchip_memory2_0
...
$(MEM_2)_START := 0x2b080000
$(MEM_2)_END := 0x2b0dffff
$(MEM_2)_SPAN := 0x00060000
